...
function ShowGrid() {
    ...
    $(window.paramFromView.GridId).jqGrid({
        ...
        datatype: 'json',
        colNames: ['Employee Id', 'Resource Name', 'Designation', 'Manager Name', 'Billable', 'Non Billable', 'Total', "Availability"],
        colModel: [
              ...
              { name: 'CurrentBillable', index: 'CurrentBillable', width: 100, formatter: 'number' },
              { name: 'CurrentNonBillable', index: 'CurrentNonBillable', width: 100, formatter: 'number' },
    ...
    //$(window.paramFromView.GridId).jqGrid('navGrid', '#pager', {
    //    search: false,
    ...
    //        ExportDataToExcel(window.paramFromView.GridId);
    //    },
    //    position: "last"
    //});
};
...
function ExportDataToExcel(tableCtrl) {
    ...
    ExportJQGridDataToExcel(tableCtrl, "Availability.xlsx");
}
